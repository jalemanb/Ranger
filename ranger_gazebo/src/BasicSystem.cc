...
#include "ranger_gazebo/BasicSystem.hh"

// This is required to register the plugin. Make sure the interfaces match
// what's in the header.
GZ_ADD_PLUGIN(
    ranger_gazebo::BasicSystem,
    gz::sim::System,
    ranger_gazebo::BasicSystem::ISystemPostUpdate)

namespace ranger_gazebo 
{
                             ...
                             const gz::sim::EntityComponentManager &_ecm)
{
  ...
  std::string msg = "Hello, BIELEFELD! Simulation is ";
  if (!_info.paused)
    msg += "not ";
  msg += "paused.";
