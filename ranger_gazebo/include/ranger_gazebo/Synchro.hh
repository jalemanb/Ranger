 ...
 *
 */
#ifndef RANGER_GAZEBO_SYNCHRO_HH_
#define RANGER_GAZEBO_SYNCHRO_HH_
...
{
  // Forward declaration
  class SynchroPrivate;

  /// \brief Synchro steering controller which can be attached to a model
        ...
        public ISystemPostUpdate
  {
    ...
    /// \brief Destructor
    public: ~Synchro() override = default;
    ...
    private: std::unique_ptr<SynchroPrivate> dataPtr;
  };
  }
}
}
